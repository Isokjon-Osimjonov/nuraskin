      ...
      <div className="max-w-[1280px] mx-auto space-y-4">
        <section className="bg-[#3A0311] rounded-3xl py-16 px-8 text-center relative overflow-hidden">
          <div className="relative z-10">
            ...
            <h1 className="text-3xl md:text-5xl font-medium text-white mb-6 leading-tight max-w-[600px] mx-auto">
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#E30B5C]/5 rounded-full blur-3xl -ml-32 -mb-32"></div>
        </section>

        {/* SECTION 2 — Who we are */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div
            className="about-store-image bg-[#f5e6ea] rounded-3xl h-64 md:h-full flex flex-col items-center justify-center text-[#E30B5C]/40 about-image-placeholder"
          ...
          <div className="bg-white border border-[#f0d0d8] rounded-3xl p-8 md:p-10 flex flex-col justify-center">
            <p className="text-[11px] tracking-[0.15em] text-[#E30B5C] font-semibold mb-4 uppercase">
              Kimligimiz
            </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            >
              <item.icon className="text-[#E30B5C] mb-4" size={24} />
              <h3 className="font-semibold text-[13px] md:text-sm text-[#3A0311] mb-2 leading-tight">
                {item.title}
              </h3>
        ...
        <div className="pt-8">
          <p className="text-[11px] tracking-[0.15em] text-[#E30B5C] font-semibold mb-6 uppercase">
            Nima uchun NuraSkin?
          </p>
          <div className="space-y-3">
            {[
              ...
              >
                <div className="w-10 h-10 bg-[#fbeaf0] rounded-full flex items-center justify-center text-[#E30B5C] font-bold text-sm flex-shrink-0">
                  {item.number}
                </div>
                <div>
                  <h3 className="font-semibold text-sm md:text-base text-[#3A0311] mb-1">
                    {item.title}
                  </h3>
        ...
        <section className="bg-[#3A0311] rounded-3xl p-10 md:p-14 text-center mt-8">
          ...
          <h2 className="text-white text-xl md:text-2xl font-medium mb-8">
          ...
          <a
            ...
            className="bg-[#E30B5C] text-white px-8 py-4 rounded-2xl text-sm font-medium inline-flex items-center gap-3 hover:bg-[#ff1a75] transition-all transform hover:scale-105 active:scale-95 shadow-lg shadow-[#E30B5C]/20"
          >
            <svg
              width="20"
              height="20"
