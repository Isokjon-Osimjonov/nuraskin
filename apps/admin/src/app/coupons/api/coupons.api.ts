...
import type { CouponResponse, CreateCouponInput, UpdateCouponInput } from '@nuraskin/shared-types';
...
export const couponsApi = {
  ...
  getById: (id: string): Promise<CouponResponse & { redemptions: any[] }> =>
    api.get<any>(`/admin/coupons/${id}`),
  ...
  delete: (id: string): Promise<void> => api.delete<any>(`/admin/coupons/${id}`),
};
