...
import { RegionalConfigTabs } from './components/RegionalConfigTabs';
...
export function ProductFormPage({
  ...
  const form = useForm<CreateProductInput>({
    ...
    defaultValues: {
      ...
      regionalConfigs: (initialData?.regionalConfigs?.length
        ? initialData.regionalConfigs
        : null
      )?.map(rc => ({
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="sm:col-span-2 space-y-5">
              ...
              {hasImage && (
                <div>
                  <AiFillButton onClick={handleAiFill} isLoading={analyzing} disabled={!hasImage} />
                </div>
              )}
                    ...
                    <FormLabel className="flex items-center gap-2">
                      ...
                      {isEdit && (
                        <Tooltip>
                          ...
                          <TooltipContent>Barcode cannot be changed after creation</TooltipContent>
                        </Tooltip>
                      )}
                    </FormLabel>
                    <FormControl>
