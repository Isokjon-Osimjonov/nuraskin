...
export const telegramApi = {
  ...
  removeChannel: (id: string): Promise<void> => 
    api.delete<any>(`/admin/telegram/channels/${id}`),
  ...
  getPost: (id: string): Promise<TelegramPostResponse & { channels: any[] }> => api.get<any>(`/admin/telegram/posts/${id}`),
  ...
  removePost: (id: string): Promise<void> => 
    api.delete<any>(`/admin/telegram/posts/${id}`),
