...
import { ArrowLeft, Send, Trash2, AlertCircle, RefreshCw, Loader2 } from 'lucide-react';
...
export function PostDetailPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'SENT':
        return <Badge className="bg-green-500 hover:bg-green-500 border-none">Yuborildi</Badge>;
      case 'SCHEDULED':
        return <Badge className="bg-blue-500 hover:bg-blue-500 border-none">Rejalashtirildi</Badge>;
      case 'FAILED':
    ...
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            onClick={() => {
              if (confirm("O'chirasizmi?")) deleteMutation.mutate();
            }}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Yuborilgan kanallar</CardTitle>
            </CardHeader>
                ...
                <TableBody>
                  {(post as any).channels?.map((c: any) => (
                    <TableRow key={c.id}>
                      ...
                      <TableCell className="font-mono text-xs">{c.messageId || '—'}</TableCell>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Ma'lumotlar</CardTitle>
            </CardHeader>
