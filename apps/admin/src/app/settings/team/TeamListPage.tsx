...
export function TeamListPage() {
  ...
  return (
    <div className="flex flex-col gap-4 md:gap-6 p-3 sm:p-4 md:p-6 max-w-5xl mx-auto w-full overflow-x-hidden">
                ...
                team.map((member: any) => (
                  <DataTableRow key={member.id}>
                    ...
                    <DataTableCell>
                      <Badge
                        variant="secondary"
                        className="font-mono text-[10px] tracking-wide rounded-full"
                      >
                        {member.role}
                      </Badge>
                    </DataTableCell>
                      ...
                      <div className="flex flex-col gap-1 items-start">
                        ...
                        {member.mustChangePassword && (
                          <span className="text-[10px] text-orange-600 font-medium italic">
                            Parolni o'zgartirishi kutilmoqda
                          </span>
                        )}
                      </div>
                    </DataTableCell>
