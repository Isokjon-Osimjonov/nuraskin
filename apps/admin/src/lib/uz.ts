...
export const UZ = {
  ...
  inventory: {
    ...
    errors: {
      ...
      cannotDeleteSold: "Foydalanilgan partiyani o'chirib bo'lmaydi",
      cannotDeleteReserved: "Faol bronlar mavjud, o'chirib bo'lmaydi",
      cannotEditInitialQty: "Sotilgan partiya miqdorini o'zgartirib bo'lmaydi",
      negativeQty: "Miqdor manfiy bo'la olmaydi",
      exceedsInitial: 'Miqdor dastlabki miqdordan oshib ketdi',
    },
  ...
  expenses: {
    ...
    errors: {
      ...
      unauthorized: "Faqat yaratgan admin o'zgartira oladi",
    },
  ...
  dashboard: {
    ...
    actions: {
      ...
      verifyPaymentDesc: 'Mijoz chek yuborgan, tasdiqlash kutilmoqda',
      readyToPack: "Yig'ish uchun tayyor",
      readyToPackDesc: "To'lov tasdiqlangan, yig'ishni boshlang",
